...
Page({
  ...
  data: {
    ...
    categoryList: [
      ...
      { id: 5, name: '节日鲜花', icon: '/assets/images/cate/cate-5.png' },
      { id: 6, name: '商务花篮', icon: '/assets/images/cate/cate-6.png' },
      { id: 7, name: '开业庆典', icon: '/assets/images/cate/cate-7.png' },
      { id: 8, name: '生日祝福', icon: '/assets/images/cate/cate-8.png' },
      { id: 9, name: '求婚花束', icon: '/assets/images/cate/cate-9.png' },
      { id: 10, name: '道歉花束', icon: '/assets/images/cate/cate-10.png' }
    ],
    activeList: [],
    hotList: [],
    guessList: []
